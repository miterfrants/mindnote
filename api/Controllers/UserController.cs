...
namespace Mindmap.Controllers
{
    ...
    public class UserController : ControllerBase
    {
        ...
        public ActionResult<board> PostBoard([FromBody] dynamic body)
        {
            ...
            {
                throw new MindMapException("Add board deny, because free account only have two boards. If you need to create new board, please pay $1 per month to subscribe our service.", HttpStatusCode.ExpectationFailed);
            }
